  ...
  return (
    <div className="hint-card-wrap">
      <div className="hint-card" ref={cardRef} data-card-id={card.id}>
        <div className="hint-card-border-top">{BORDER_H}</div>
        <div className="hint-card-border-bottom">{BORDER_H}</div>
        <div className="hint-card-border-left"><span>{BORDER_V}</span></div>
        <div className="hint-card-border-right"><span>{BORDER_V}</span></div>
        <div className="hint-card-inner">
          <p className="hint-card-you-are-given type-caps">YOU ARE GIVEN A</p>
          <h1 className="hint-card-hint">HINT</h1>
          ...
          <p className="hint-card-tag">{card.tag}</p>
